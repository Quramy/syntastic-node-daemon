...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_syntastic_node_daemon#Web#JSON#import() abort
  ...
  execute join(['function! vital#_syntastic_node_daemon#Web#JSON#import() abort', printf("return map({'decode': '', '_vital_depends': '', '_vital_created': '', 'encode': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
