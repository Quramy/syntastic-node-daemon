...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_syntastic_node_daemon#ProcessManager#import() abort
  ...
  execute join(['function! vital#_syntastic_node_daemon#ProcessManager#import() abort', printf("return map({'read': '', '_vital_depends': '', 'touch': '', 'read_wait': '', 'writeln': '', 'write': '', 'kill': '', 'state': '', 'term': '', 'is_available': '', 'debug_processes': '', 'status': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
